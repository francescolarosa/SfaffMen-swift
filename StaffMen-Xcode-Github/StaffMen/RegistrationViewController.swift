...
//        }, completion: nil)
    ...
    @IBAction func registerButton(_ sender: UIButton) {
        if nameTextField.isNull {
            NBMaterialToast.showWithText(view, text: "Please enter full Name", duration: NBLunchDuration.long)
        }
            ...
            NBMaterialToast.showWithText(view, text: "Please enter Confirm Password", duration: NBLunchDuration.long)
        }
        else if passwordTextField.text != passwordConfirmTextField.text {
            NBMaterialToast.showWithText(view, text: "Password and confirm password not match", duration: NBLunchDuration.long)
        }
        else{
